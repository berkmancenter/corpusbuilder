...
ActiveRecord::Schema.define(version: 20180411115247) do
  ...
  create_table "graphemes_revisions_3899aaa2_9bc8_45c1_ade4_172231ad8c8a", id: false, force: :cascade do |t|
    t.uuid "grapheme_id"
  end

  create_table "graphemes_revisions_3a5f3676_3f74_4753_8e0c_f9599efa8768", id: false, force: :cascade do |t|
    t.uuid "grapheme_id"
  end
  ...
  create_table "graphemes_revisions_42458a37_41c7_46c6_ac30_9ac2a46f436d", id: false, force: :cascade do |t|
    t.uuid "grapheme_id"
  end
  ...
  create_table "graphemes_revisions_9513a3e7_197c_480b_ad4f_59dc4f9eb3c7", id: false, force: :cascade do |t|
    t.uuid "grapheme_id"
  end
  ...
  create_table "graphemes_revisions_be99f867_e0b7_43b1_a922_44a702b9a1a4", id: false, force: :cascade do |t|
    t.uuid "grapheme_id"
  end
